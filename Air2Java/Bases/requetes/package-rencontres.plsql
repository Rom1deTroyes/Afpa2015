-- Package Rencontres
-- Pour tout ce qui touche aux Rencontres
CREATE OR REPLACE PACKAGE Pack_Rencontres IS
...
/*
	FUNCTION groupe_not_in_rencontre(r_Id rencontres.id_rencontre%TYPE)
		RETURN Pack_Rencontres.tgroupe ;
*/
	FUNCTION get_id_last_rencontre
		RETURN rencontres.id_rencontre%TYPE ;
END Pack_Rencontres ;
/
CREATE OR REPLACE PACKAGE BODY Pack_Rencontres IS
...
/*
   ...
   set serveroutput on; 
   set showmode on;  
exec Pack_Rencontres.groupe_not_in_rencontre(&rid) ;
-- Tests id_last_rencontre
select Pack_Rencontres.get_id_last_rencontre() from dual ;
select * from rencontres where id_rencontre = Pack_Rencontres.get_id_last_rencontre() ;
